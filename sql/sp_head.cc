...
bool sp_package::get_typedef(THD *thd,
...
*/
bool sp_head::get_typedef_package_spec(THD *thd,
                                       const sp_type_def **tdef,
                                       const Lex_ident_sys_st &package,
                                       const Lex_ident_sys_st &type)
{
  ...
  */
      ...
      Lex_ident_routine(m_name).streq(package))
  {
    ...
    */
    ...
    DBUG_ASSERT(spec);
    return spec->get_typedef(thd, tdef,
  ...
  */
  ...
  return get_typedef_package_spec(thd, tdef,
  ...
  */
      ...
      Lex_ident_routine(m_name).streq(package))
  {
    ...
    */
    sp_package *spec= get_package();
    DBUG_ASSERT(spec);
    return spec->get_typedef(thd, tdef, dbn, package, type);
  }
